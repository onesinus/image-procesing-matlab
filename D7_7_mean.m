...
for baris = 4 : tinggi-4
    for kolom = 4 : lebar-4
        ...
        total_nilai = 0;
        for i = 1 : 48
        	total_nilai = total_nilai + Temp(i);
        end

       	nilai_mean = total_nilai / 48;

        % Mengganti nilai piksel pada titik tengah dengan nilai rata-rata
        G(baris, kolom) = nilai_mean;
    end
end